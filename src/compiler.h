...
typedef enum compiler_op_code {
	...
	COMPILER_OP_CODE_POP_ATOM_TYPESIGS,
	...
	COMPILER_OP_CODE_LONG_SUBTRACT,
	...
	COMPILER_OP_CODE_LONG_INCREMENT,
	COMPILER_OP_CODE_LONG_DECREMENT,
	COMPILER_OP_CODE_FLOAT_INCREMENT,
	COMPILER_OP_CODE_FLOAT_DECREMENT,
	...
	COMPILER_OP_CODE_CONFIG_TYPEGUARD,
	COMPILER_OP_CODE_CONFIG_PROPERTY_TYPEGUARD,
	COMPILER_OP_CODE_TYPEGUARD_PROTECT_ARRAY,
	COMPILER_OP_CODE_TYPEGUARD_PROTECT_PROPERTY
} compiler_op_code_t;
